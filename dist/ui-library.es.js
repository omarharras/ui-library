...
var oe = ne();
const se = ({ children: c, onClick: f, className: i }) => /* @__PURE__ */ oe.jsx(
  "button",
  {
    onClick: f,
    className: `px-10 py-3 text-xl rounded font-bold bg-green-500 text-white ${i}`,
    children: c
  }
);
export {
